...
gui.blazedLoader:Destroy()
    ...
    local Library = loadstring(game:HttpGet('https://blazed.lol/Library/main.lua'))()
    local ThemeManager = loadstring(game:HttpGet('https://blazed.lol/Library/theme.lua'))()
    local SaveManager = loadstring(game:HttpGet('https://blazed.lol/Library/config.lua'))()
    ...
    do
        ...
        InventoryChanger.Functions.Reload = function()
            ...
            Notifications("Open The Gun Skin UI")
...
-- // Dependencies
local Aiming = loadstring(game:HttpGet("https://blazed.lol/modules/silent.lua"))()
...
--
    ...
    Options.VisualizeRotationColor:OnChanged(function()
        Lock.Drawings.TargetStrafeCircle.Color = Options.VisualizeRotationColor.Value
        Lock.Drawings.TargetStrafeCircle.Transparency = Options.VisualizeRotationColor.Transparency
    end)
